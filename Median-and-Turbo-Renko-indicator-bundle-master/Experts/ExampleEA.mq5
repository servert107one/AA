...
#property description "EA displays the date/time of the new bar plus the OPEN price &&"
#property description "the data/time of the previous bar." 
#property strict
...
void OnDeinit(const int reason)
{
   ...
   // clear the comments from the chart
   Comment("");
